...
// ── Settled-zoom snap band (terminal raster fix) ───────────────────────────────
// useZoomSettle snaps a SETTLED zoom inside the band to exactly 100%: an almost-1
// settle is almost never intentional, and exactly-1 is the nicest terminal state
// (integer-ish effective font, zero counter-scale slack). The settled zoom also
// drives the terminal FREEZE re-raster (counter-scale + effective font — see
// useTerminalSpawn), which keeps the terminal crisp at EVERY settled zoom; the
// snap is a comfort lever on top, no longer the crispness mechanism.
// History: docs/research/2026-06-11-terminal-font-blur.md (#122) +
// docs/research/2026-06-12-terminal-native-reraster-audit.md.
