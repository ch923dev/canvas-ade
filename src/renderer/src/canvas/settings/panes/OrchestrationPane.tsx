 ...
 *
 * S1: the Phase-1 "Lead terminal" picker that lived here was a TEMPORARY proof surface and is
 * REMOVED (user directive) — the lead role is now granted at terminal creation ("Spawn as
 * orchestrator" in the New Terminal dialog: designation precedes the first spawn, so no restart)
 * or from a terminal board's ⋯ menu (promote/revoke; the LEAD badge answers "who holds it").
 * The consent-gated IPC + leadAuthority plumbing underneath is unchanged.
 */
