...
| [`research/`](research/) | Standalone research notes (`electron-e2e-testing.md`, `self-smoke-testing.md`, `excalidraw-feature-borrowing.md`, `drawio-feature-borrowing.md`). | ✅ live |
